...
typedef enum{
    ...
    WTIM0_AB = 0x40036000, WTIM0_A = 0x40036001, WTIM0_B = 0x40036002,
    WTIM1_AB = 0x40037000, WTIM1_A = 0x40037001, WTIM1_B = 0x40037002,
    WTIM2_AB = 0x4004C000, WTIM2_A = 0x4004C001, WTIM2_B = 0x4004C002,
    WTIM3_AB = 0x4004D000, WTIM3_A = 0x4004D001, WTIM3_B = 0x4004D002,
    WTIM4_AB = 0x4004E000, WTIM4_A = 0x4004E001, WTIM4_B = 0x4004E002,
    WTIM5_AB = 0x4004F000, WTIM5_A = 0x4004F001, WTIM5_B = 0x4004F002
}GPTM_MODULE;
